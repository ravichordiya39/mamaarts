...
select.goog-te-combo option {
    background: #fff;
      ...
      <link href="<?php echo url("front/css/story.css")?>" rel="stylesheet"> 
            ...
            <div id="page-content-wrapper">
               ...
               <nav class="navbar navbar-expand-md navbar-light bg-light  fixed-top">
                  ...
                  <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item  ">
                           ...
                           <a class="nav-link px-1 underline" href="<?php echo url("/");?>">Home </a>
                  ...
                  <div class="mx-auto order-0">
                     ...
                     <a href="<?php echo url("/");?>"><img src="<?php echo url("front/images/logo1.png");?>" class="  d-lg-none " height="65px"> </a>
                     ...
                     <div class="row align-items-top    text-md-left">
                        <div class="col-12 col-sm-12 col-md-3">
						   ...
						   <p class="subsmsgalert">You have already subscribed! </p>
                              ...
                              <input type="text" name="mobile" onkeypress="return isNumber(event)" class="formStyle" placeholder="Phone (required)" required="">
